...
To check that your configuration is at least free of the most common errors, run the `grade3.sh` script (if this doesn't exist already, we'll later post instructions here and on Ed on how to get it), which will tell you if there are any obvious errors with your code.
