...
{{< callout type="warning" >}}
Do *NOT* name the file the UUID value of the flag, make sure it is called `SUNET` and the contents of the file should be the flag. Calling the file `6b3310f5-48f8-48a1-b610-7d3e8c774abe` would be incorrect.
{{< /callout >}}
